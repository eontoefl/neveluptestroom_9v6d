...
class DiscussionComponent {
    constructor() {
        ...
        this.PROFESSOR_PROFILES = {
            male: 'https://eontoefl.github.io/eontoefl_html/discussion/professor_m.png',
            female: 'https://eontoefl.github.io/eontoefl_html/discussion/professor_f.png'
        };
        
        // 여학생 프로필 (7명)
        this.FEMALE_STUDENT_PROFILES = [
            { name: 'Amy', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_f01.png' },
            { name: 'Emma', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_f02.png' },
            { name: 'Anna', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_f03.png' },
            { name: 'Lucy', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_f04.png' },
            { name: 'Mia', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_f05.png' },
            { name: 'Lily', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_f06.png' },
            { name: 'Sarah', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_f07.png' }
        ];
        
        // 남학생 프로필 (7명)
        this.MALE_STUDENT_PROFILES = [
            { name: 'Tom', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_m01.png' },
            { name: 'Jack', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_m02.png' },
            { name: 'Ben', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_m03.png' },
            { name: 'Sam', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_m04.png' },
            { name: 'John', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_m05.png' },
            { name: 'Paul', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_m06.png' },
            { name: 'Mark', image: 'https://eontoefl.github.io/eontoefl_html/discussion/student_m07.png' }
        ];
    ...
    parseDiscussionCSV(csvText) {
        ...
        for (const line of lines) {
            ...
            // 22개 컬럼 예상
            if (fields.length < 22) {
                console.warn('⚠️ 컬럼 수 부족:', fields.length, '예상: 22');
                continue;
            }
            ...
            const setData = {
                setNumber: fields[0] || '',
                weekDay: fields[1] || '',
                classContext: fields[2] || '',
                topic: fields[3] || '',
                student1Opinion: fields[4] || '',
                student2Opinion: fields[5] || '',
                sampleAnswer: fields[6] || '',
                // Bullet 1
                bullet1Sentence: fields[7] || '',
                bullet1ETS: fields[8] || '',
                bullet1Strategy: fields[9] || '',
                // Bullet 2
                bullet2Sentence: fields[10] || '',
                bullet2ETS: fields[11] || '',
                bullet2Strategy: fields[12] || '',
                // Bullet 3
                bullet3Sentence: fields[13] || '',
                bullet3ETS: fields[14] || '',
                bullet3Strategy: fields[15] || '',
                // Bullet 4 (선택)
                bullet4Sentence: fields[16] || '',
                bullet4ETS: fields[17] || '',
                bullet4Strategy: fields[18] || '',
                // Bullet 5 (선택)
                bullet5Sentence: fields[19] || '',
                bullet5ETS: fields[20] || '',
                bullet5Strategy: fields[21] || ''
            };
