...
class RepeatComponent {
    ...
    showRepeatResultNarration(set, index) {
        ...
        // Script 표시
        document.getElementById('repeatResultScript').innerHTML = 
            `<div class="repeat-result-script-label">📝 Script</div>
            <div class="repeat-result-script-text">${audio.script}</div>`;
        
        // Translation 표시
        document.getElementById('repeatResultTranslation').innerHTML = 
            `<div class="repeat-result-translation-label">🇰🇷 Translation</div>
            <div class="repeat-result-translation-text">${audio.translation}</div>`;
